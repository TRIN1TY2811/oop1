...
public class JamesEarlAttendance extends JFrame implements ActionListener {
    ...
    private JPanel createOOPPanel() {
        ...
        panel.add(createLabel("Week 1", 203, 100));
        panel.add(createLabel("Week 2", 281, 100));
        panel.add(createLabel("Week 3", 361, 100));
        panel.add(createLabel("Week 4", 445, 100));
        panel.add(createLabel("Week 5", 525, 100)); 
        int yStart = 120;
        ...
        for (int i = 0; i < 10; i++) {
           ...
           oopID[i] = addField(panel, "", 20, y, 90, 30);
            ...
            oopWeek[i][4] = addField(panel, "", 540, y, 70, 30);
        }
    ...
    private JPanel createIntegPanel() {
        ...
        for (int i = 0; i < 10; i++) {
           ...
           integID[i] = addField(panel, "", 20, y, 90, 30);
            ...
            integWeek[i][4] = addField(panel, "", 540, y, 70, 30);
        }
    ...
    private JPanel createCompPanel() {
       ...
       panel.add(createLabel("Student ID", 19, 100));
        ...
        for (int i = 0; i < 10; i++) {
            ...
            cpWeek[i][4] = addField(panel, "", 540, y, 70, 30);
        }
    ...
    private JPanel createNetAdPanel() {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            netWeek[i][4] = addField(panel, "", 540, y, 70, 30);
        }
    ...
    private JPanel createOSPanel() {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            osWeek[i][4] = addField(panel, "", 540, y, 70, 30);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        //  SUBMIT OOP 
            ...
            try {
                ...
                JOptionPane.showMessageDialog(this, savedRows + " new OOP Attedance saved safely!");
                pst.close(); conn.close();
                executeDatabaseSearch(); // Auto-refresh panel
            } catch (Exception ex) { 
                ex.printStackTrace(); 
        ...
        //  SUBMIT INTEG 
            ...
            try {
                ...
                JOptionPane.showMessageDialog(this, savedRows + " new Integrative Grade(s) saved safely!");
                pst.close(); conn.close();
                executeDatabaseSearch();
            } catch (Exception ex) { 
                ex.printStackTrace(); 
        ...
        //  SUBMIT CP 
            ...
            try {
                ...
                JOptionPane.showMessageDialog(this, savedRows + " new Computer Programming Attendance saved safely!");
                pst.close(); conn.close();
                executeDatabaseSearch();
            } catch (Exception ex) { 
                ex.printStackTrace(); 
        ...
        //  SUBMIT NET 
            ...
            try {
                ...
                JOptionPane.showMessageDialog(this, savedRows + " new Network Grade(s) saved safely!");
                pst.close(); conn.close();
                executeDatabaseSearch();
            } catch (Exception ex) { 
                ex.printStackTrace(); 
        ...
        //  SUBMIT OS 
            ...
            try {
                ...
                JOptionPane.showMessageDialog(this, savedRows + " new OS Grade(s) saved safely!");
                pst.close(); conn.close();
                executeDatabaseSearch();
            } catch (Exception ex) { 
                ex.printStackTrace(); 
        ...
        //  UPDATE INTEG 
            ...
            try {
                ...
                for (int i = 0; i < 10; i++) {
                    ...
                    pst.setString(7, integID[i].getText());
                    updatedCount += pst.executeUpdate();
                }
                JOptionPane.showMessageDialog(this, updatedCount + " Record(s) updated successfully!");
                pst.close(); conn.close();
        ...
        //  UPDATE CP 
            ...
            try {
                ...
                for (int i = 0; i < 10; i++) {
                    ...
                    pst.setString(7, cpID[i].getText());
                    updatedCount += pst.executeUpdate();
                }
                JOptionPane.showMessageDialog(this, updatedCount + " Record(s) updated successfully!");
                pst.close(); conn.close();
        ...
        //  UPDATE NET 
            ...
            try {
                ...
                Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/schoolsystemdb", "root", "");
                String sql =
                "INSERT INTO netattendance (ID, Name, Week1, Week2, Week3, Week4, Week5) " +
                "VALUES (?,?,?,?,?,?,?) " +
                ...
                for (int i = 0; i < 10; i++) {
                    ...
                    pst.setString(7, netID[i].getText());
                    updatedCount += pst.executeUpdate();
                }
                JOptionPane.showMessageDialog(this, updatedCount + " Record(s) updated successfully!");
                pst.close(); conn.close();
        ...
        //  UPDATE OS 
            ...
            try {
                ...
                for (int i = 0; i < 10; i++) {
                    ...
                    pst.setString(7, osID[i].getText());
                    updatedCount += pst.executeUpdate();
                }
                JOptionPane.showMessageDialog(this, updatedCount + " Record(s) updated successfully!");
                pst.close(); conn.close();
